...
def TransCLIP_solver(support_features, support_labels, val_features, val_labels, query_features, query_labels,
                     ...
                     gamma_override=None, lambda_override=None, n_neighbors_override=None):
    """
    ...
    std_init = 1 / d
    n_neighbors = n_neighbors_override if n_neighbors_override is not None else 3
    ...
    lambda_value, gamma_list, support_features, support_labels = get_parameters(support_labels, support_features, gamma_override=gamma_override, lambda_override=lambda_override)
