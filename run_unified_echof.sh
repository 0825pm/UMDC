...
def parse_args():
    ...
    parser.add_argument("--ft_epo", type=int, default=500, help="Fine-tuning epochs for train_compact")
...
def main():
    ...
    print(f"  clap_lambda={args.clap_lambda}, ft_epo={args.ft_epo}")
    ...
    print(f"  Config: zip={args.zip_config_index}, beta={args.acti_beta}, clap_lambda={args.clap_lambda}, ft_epo={args.ft_epo}")
